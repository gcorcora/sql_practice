-- Join Operations from https://sqlzoo.net/wiki/More_JOIN_operations

-- Utilizes tables "actor," "movie," and "casting."
...
SELECT UNIQUE(name) FROM actor JOIN casting ON (actor.id = actorid) 
